...
[CustomPropertyDrawer(typeof(GroundProperties))]
public class GroundPropertiesCustomDrawer : PropertyDrawer
{
    ...
    public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
    {
        ...
        switch (trajectoryInt){
            case 1: 
                var slideProp = property.FindPropertyRelative("Slide");
            ...
            case 2:
                var trajProp = property.FindPropertyRelative("Trajectory");
